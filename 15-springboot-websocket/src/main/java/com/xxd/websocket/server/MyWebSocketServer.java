package com.xxd.websocket.server;
...
public class MyWebSocketServer {
     ...
     */
    private static final ConcurrentHashMap<String, MyWebSocketServer> webSocketMap = new ConcurrentHashMap<>();
    /**
    ...
    public void onMessage(String message, Session session) {
        ...
        if (null != message) {
            try {
                ...
                //追加发送人(防止串改)
                jsonObject.append("fromUserId", this.userId);
